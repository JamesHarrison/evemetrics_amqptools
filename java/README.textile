...
The Java example clients use the "RabbitMQ Java Client":http://www.rabbitmq.com/java-client.html which must be downloaded and installed to run the example clients.
